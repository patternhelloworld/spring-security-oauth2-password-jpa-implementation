...
NGINX_SERVICE_FILE_PATH_NAME=/etc/nginx/conf.d/spring-security-oauth2-password-jpa-implementation-service-url.inc
...
PRODUCTION_PATH=/var/www/server/spring-security-oauth2-password-jpa-implementation
# pom.xml 과 반드시 같은 pattern 이어야 한다.
SERVER_IMAGE_NAME_PATTERN=spring-security-oauth2-password-jpa-implementation-[0-9.]*-SNAPSHOT.jar
