...
public class OAuth2AuthorizationBuildingServiceImpl implements OAuth2AuthorizationBuildingService {
    ...
    private OAuth2Authorization build(String clientId, UserDetails userDetails,
                                      KnifeGrantAuthenticationToken knifeGrantAuthenticationToken,
        ...
        OAuth2Token accessToken = customTokenGenerator.generate(DefaultOAuth2TokenContext.builder()
                ...
                .principal(knifeGrantAuthenticationToken)
                .authorizationServerContext(AuthorizationServerContextHolder.getContext())
                .tokenType(OAuth2TokenType.ACCESS_TOKEN)
                .authorizationGrantType(knifeGrantAuthenticationToken.getGrantType())
                .authorizationGrant(knifeGrantAuthenticationToken)
        ...
        return OAuth2Authorization
                ...
                .authorizationGrantType(knifeGrantAuthenticationToken.getGrantType())
                .attribute("authorities", knifeGrantAuthenticationToken.getAuthorities())
                .attributes(attrs -> attrs.putAll(knifeGrantAuthenticationToken.getAdditionalParameters()))
    ...
    public OAuth2Authorization build(UserDetails userDetails, AuthorizationGrantType grantType,String clientId,
        ...
        KnifeGrantAuthenticationToken knifeGrantAuthenticationToken =
                new KnifeGrantAuthenticationToken(grantType, userDetails, additionalParameters);

        return build(clientId, userDetails, knifeGrantAuthenticationToken, shouldBePreservedRefreshToken);
    }
