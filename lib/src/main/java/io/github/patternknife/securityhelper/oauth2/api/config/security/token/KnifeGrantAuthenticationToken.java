...
public class KnifeGrantAuthenticationToken extends AbstractAuthenticationToken {
    ...
    // Constructor
    public KnifeGrantAuthenticationToken(AuthorizationGrantType grantType, Object principal, Map<String, Object> additionalParameters) {
