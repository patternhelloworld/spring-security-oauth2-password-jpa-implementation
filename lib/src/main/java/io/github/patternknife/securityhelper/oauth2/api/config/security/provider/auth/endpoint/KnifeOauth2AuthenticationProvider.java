            ...
            * */
            if (authentication instanceof CustomGrantAuthenticationToken customGrantAuthenticationToken) {
                ...
                * */
                ...
                OAuth2Authorization  oAuth2Authorization = oAuth2AuthorizationService.findByAuthorizationCode(((OAuth2AuthorizationCodeAuthenticationToken) authentication).getCode());
                if(oAuth2Authorization == null){
                ...
                oAuth2Authorization = commonOAuth2AuthorizationSaver.save(userDetails, new AuthorizationGrantType("password"), clientId, ((CustomGrantAuthenticationToken) authentication).getAdditionalParameters(), null);
