...
@Configuration
public class KnifeJwtConfig {

    private static final Logger logger = LoggerFactory.getLogger(KnifeJwtConfig.class);

    @Value("${patternknife.securityhelper.jwt.secret:5pAq6zRyX8bC3dV2wS7gN1mK9jF0hL4tUoP6iBvE3nG8xZaQrY7cW2fA}")
    private String jwtSecret;

    @Value("${patternknife.securityhelper.jwt.algorithm:HmacSHA256}")
