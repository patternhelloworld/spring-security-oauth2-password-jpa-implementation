package io.github.patternhelloworld.securityhelper.oauth2.api.config.security.core;
...
/**
 * The {@code EasyPlusUserInfo} class extends {@link User} and implements {@link OAuth2AuthenticatedPrincipal}.
 ...
 */
public class EasyPlusUserInfo<T> extends User implements OAuth2AuthenticatedPrincipal {
	...
	public EasyPlusUserInfo(String username, String password, Collection<? extends GrantedAuthority> authorities) {
		super(username, password, authorities);
	}

	public EasyPlusUserInfo(String username, String password, boolean enabled, boolean accountNonExpired,
