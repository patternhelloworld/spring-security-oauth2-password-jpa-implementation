...
import io.github.patternhelloworld.securityhelper.oauth2.api.config.util.SerializableObjectConverter;
...
@Getter
@Setter
public class EasyPlusAuthorization {
