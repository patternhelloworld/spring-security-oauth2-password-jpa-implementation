package io.github.patternhelloworld.securityhelper.oauth2.api.config.security.token;
...
public class EasyPlusGrantAuthenticationToken extends AbstractAuthenticationToken {
    ...
    // Constructor
    public EasyPlusGrantAuthenticationToken(AuthorizationGrantType grantType, Object principal, Map<String, Object> additionalParameters) {
