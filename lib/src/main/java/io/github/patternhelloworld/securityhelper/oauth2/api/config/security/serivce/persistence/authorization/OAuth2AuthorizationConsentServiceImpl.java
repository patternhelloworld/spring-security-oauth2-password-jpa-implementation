...
public class OAuth2AuthorizationConsentServiceImpl implements OAuth2AuthorizationConsentService {
    private final EasyPlusAuthorizationConsentRepository authorizationConsentRepository;
    private final RegisteredClientRepository registeredClientRepository;

    public OAuth2AuthorizationConsentServiceImpl(EasyPlusAuthorizationConsentRepository authorizationConsentRepository, RegisteredClientRepository registeredClientRepository) {
    ...
    private OAuth2AuthorizationConsent toObject(EasyPlusAuthorizationConsent authorizationConsent) {
    ...
    private EasyPlusAuthorizationConsent toEntity(OAuth2AuthorizationConsent authorizationConsent) {
        EasyPlusAuthorizationConsent entity = new EasyPlusAuthorizationConsent();
