package com.patternhelloworld.securityhelper.oauth2.client.domain.admin.service;
...
import com.patternhelloworld.securityhelper.oauth2.client.config.database.SelectablePersistenceConst;
import com.patternhelloworld.securityhelper.oauth2.client.config.response.error.exception.data.ResourceNotFoundException;
import com.patternhelloworld.securityhelper.oauth2.client.domain.admin.entity.*;
import io.github.patternhelloworld.securityhelper.oauth2.api.config.security.core.EasyPlusUserInfo;
import com.patternhelloworld.securityhelper.oauth2.client.domain.admin.dto.QAdminDTO_OneWithRoleIdsRes;
import com.patternhelloworld.securityhelper.oauth2.client.domain.admin.entity.*;
import com.patternhelloworld.securityhelper.oauth2.client.domain.common.dto.DateRangeFilter;
import com.patternhelloworld.securityhelper.oauth2.client.domain.common.dto.SorterValueFilter;
import com.patternhelloworld.securityhelper.oauth2.client.domain.role.dao.RoleRepository;
...
import com.patternhelloworld.securityhelper.oauth2.client.util.PaginationUtil;
import com.patternhelloworld.securityhelper.oauth2.client.domain.admin.dao.AdminRepository;
import com.patternhelloworld.securityhelper.oauth2.client.domain.admin.dao.AdminRoleRepository;
import com.patternhelloworld.securityhelper.oauth2.client.domain.admin.dto.AdminDTO;
import com.patternhelloworld.securityhelper.oauth2.client.domain.admin.dto.AdminSearchFilter;
...
public class AdminService extends CommonQuerydslRepositorySupport {
    ...
    public Boolean checkSuperAdminFromAccessTokeAdminInfo(EasyPlusUserInfo easyPlusUserInfo) throws ResourceNotFoundException {

        Boolean superAdmin = false;

        Set<String> adminRoles = AuthorityUtils.authorityListToSet(easyPlusUserInfo.getAuthorities());
    ...
    public Page<AdminDTO.OneWithRoleIdsRes> findAdminsByPageRequest(Boolean skipPagination,
                                                                    ...
                                                                    EasyPlusUserInfo easyPlusUserInfo) throws JsonProcessingException, ResourceNotFoundException {
