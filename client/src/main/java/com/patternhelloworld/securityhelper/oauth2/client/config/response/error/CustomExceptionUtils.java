...
import com.patternhelloworld.securityhelper.oauth2.client.config.logger.module.ResponseSuccessLogConfig;
...
public class CustomExceptionUtils {
    ...
    public static void createNonStoppableErrorMessage(String message) {
        ...
        try {
            ...
            SecurityEasyPlusErrorResponsePayload errorResponsePayload = new SecurityEasyPlusErrorResponsePayload(message, "Without error param " + " / Thread ID = " + Thread.currentThread().getId() + " / StackTrace",
                    message, "", "");
