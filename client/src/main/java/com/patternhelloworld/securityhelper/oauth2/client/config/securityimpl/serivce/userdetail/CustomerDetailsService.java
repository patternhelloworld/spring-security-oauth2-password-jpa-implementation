...
import com.patternhelloworld.securityhelper.oauth2.client.config.response.error.exception.auth.UserDeletedException;
...
import com.patternhelloworld.securityhelper.oauth2.client.domain.customer.entity.QCustomer;
import com.patternhelloworld.securityhelper.oauth2.client.domain.customer.entity.QCustomerRole;
...
public class CustomerDetailsService extends QuerydslRepositorySupport implements UserDetailsService {
    ...
    * */
    ...
    private EasyPlusUserInfo<CustomizedUserInfo> buildCustomerForAuthentication(Customer customer, Collection<? extends GrantedAuthority> authorities) {
        ...
        EasyPlusUserInfo<CustomizedUserInfo> authCustomer = new EasyPlusUserInfo<>(customername, password, enabled, accountNonExpired, credentialsNonExpired,
