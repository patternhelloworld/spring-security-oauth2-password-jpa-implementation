package com.patternhelloworld.securityhelper.oauth2.client.unit.customer;
...
import com.patternhelloworld.securityhelper.oauth2.client.util.auth.MockAuth;
import com.patternhelloworld.securityhelper.oauth2.client.util.auth.UnitMockAuth;
import com.patternhelloworld.securityhelper.oauth2.client.domain.customer.api.CustomerApi;
...
public class CustomerApiTest {
    ...
    private EasyPlusUserInfo easyPlusUserInfo;
    ...
    private HandlerMethodArgumentResolver putAuthenticationPrincipal = new HandlerMethodArgumentResolver() {
        ...
        public boolean supportsParameter(MethodParameter parameter) {
            return parameter.getParameterType().isAssignableFrom(EasyPlusUserInfo.class);
        }

        @Override
        public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
                                      NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
            return easyPlusUserInfo;
        }
    };
    ...
    public void setUp(RestDocumentationContextProvider restDocumentationContextProvider) throws Exception {
        ...
        easyPlusUserInfo = customerUtils.mockAuthenticationPrincipal(u);
