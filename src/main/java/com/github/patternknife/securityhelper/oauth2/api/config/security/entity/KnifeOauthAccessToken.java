package com.github.patternknife.securityhelper.oauth2.api.config.security.entity;

import com.github.patternknife.securityhelper.oauth2.api.config.security.util.SerializableObjectConverter;
...
@Data
@DynamicUpdate
public class KnifeOauthAccessToken {
