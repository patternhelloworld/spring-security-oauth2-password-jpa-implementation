...
import com.patternknife.securityhelper.oauth2.config.security.serivce.client.RegisteredClientRepositoryImpl;
                ...
                .tokenEndpoint(tokenEndpoint ->
                        tokenEndpoint
                                ...
                                .authenticationProvider(new CustomAuthenticationProvider(
                                        commonOAuth2AuthorizationCycle, conditionalDetailsService, oauth2AuthenticationService, authorizationService
                                ))
